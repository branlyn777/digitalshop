            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                     ...
                     <li class="divider"></li>
                     <li><a href=" <?php echo base_url(); ?>47admin/#">Profile</a>
                     </li>
                     ...
                     <li><a href=" <?php echo base_url(); ?>47admin/#">Logout</a>
                     </li>
                  </ul>
                  <!-- END Dropdown menu-->
               </li>
         ...
         <nav class="sidebar">
            <ul class="nav">
               ...
               <li>
                  <div data-toggle="collapse-next" class="item user-block has-submenu">
                     ...
                     <div class="user-block-picture">
                        <img src=" <?php echo base_url(); ?>47admin/app/img/user/02.jpg" alt="Avatar" width="60" height="60" class="img-thumbnail img-circle">
               ...
               <li>
                  ...
                  <ul class="nav collapse ">
                     <li>
                        <a href=" <?php echo base_url(); ?>47admin/dashboard.html" title="Default" data-toggle="" class="no-submenu">
