          ...
          ?>
            ...
            <div class="col-lg-5">            
                  ...
                  <div class="form-group">
                     ...
                     <input disabled type="text" placeholder="" id="nombre" class="form-control" name="razonsocial" required pattern="[A-Za-z0-9| ]+" title="Letras y números. Tamaño mínimo: 5. Tamaño máximo: 17">
                  </div>
                  <div class="form-group">
                     <label>Número de Carnet</label>
                     <input disabled type="text" placeholder="" id="carnet" class="form-control" name="nit" required="" required pattern="[A-Za-z0-9| ]+" title="Letras y números. Tamaño mínimo: 5. Tamaño máximo: 17">
                  </div>
                   <br>
                   <label>Seleccione el Género</label>
                        <select disabled id="prueba" style="width: 120px;"  class="form-control form-control-lg" name="genero">
            ...
            <center>
               <label>Seleccione el Producto</label>
                        ...
                        <table id="datatable1" class="table table-striped table-hover">
                           <thead>
                              <tr>
                                 ...
                                 <th><center>Precio Base</center></th>
                           ...
                           ?>
                              <tr class="gradeX">
                                 ...
                                 <td style="float: right;"><?php echo $row->preciobase; ?> Bs</td> 
                                 <td >
                                    <center>
                                       <input type="checkbox" id="marcar" onclick="contarsi()" name="idproducto" value="<?php echo $row->idproducto ?>">
                                    </center>
                                 </td>  
                                 <td >
                                    <select style="width: 77px;" onchange="actualizarvalue()" class="chosen-select" id="cantidades" name="cantidad">
                                       <?php
                                          for ($i=0;$i < $row->cantidad +1 ;  $i++) { 
                                              
                                            echo'<option value="'.$i.'">'?><?php echo $i ?></option>
                                       <?php
                                          }
                                       ?>
                                    </select>
                  ...
                  <input type="" value="0" name="" id="total">
