               ...
               <div class="col-sm-6">
                  ...
                  <div class="panel panel-default">
                     <div class="panel-body">
                           ...
                           echo form_open_multipart('smartphones/modificarbd',$atributos);
                           foreach ($infosmartphone->result() as $row)
                           {
                           ?>
                           <div class="form-group">
                              <label>Nombre Dispositivo</label>
                              <input type="hidden" placeholder="Inserte el Nombre aquí" name="idsmartphone" value="<?php echo $row->idsmartphone; ?>">
                              <input type="text" name="nombreproducto" class="form-control" value="<?php echo $row->nombreproducto; ?>">
                           </div>
                           <div class="form-group">
                             <label>Almacenamiento</label>
                             <br>
                                <select name="almacenamiento" class="form-control m-b" value="<?php echo $row->idsmartphone; ?>">
                                 <option><?php echo $row->almacenamiento; ?></option>
                                 <option>4</option>
                                 <option>8</option>
                                 <option>16</option>
                                 <option>32</option>
                           ...
                           <div class="form-group">
                             ...
                             <br>
                                <select name="camarafrontal" class="form-control m-b" value="<?php echo $row->idsmartphone; ?>">
                                 <option><?php echo $row->camarafrontal; ?></option>
                                 <option>13</option>
                                 <option>16</option>
                                 <option>20</option>
                                 <option>64</option>
                           ...
                           <div class="form-group">
                             ...
                             <br>
                                <select name="camaratrasera" class="form-control m-b" value="<?php echo $row->idsmartphone; ?>">
                                 <option><?php echo $row->camaratrasera; ?></option>
                                 <option>13</option>
                                 <option>16</option>
                                 <option>20</option>
                                 <option>64</option>
                           ...
                           <div class="form-group">
                              ...
                              <input type="hidden"  class="form-control" name="idsmartphone" value="<?php echo $row->idsmartphone; ?>">
                              <input type="text" name="procesador" class="form-control" value="<?php echo $row->procesador; ?>">
                           </div>
                  ...
                  <div class="panel panel-default">
                     <div class="panel-body">
                           <div class="form-group">
                             ...
                             <br>
                                <select name="dualsim" class="form-control m-b" value="<?php echo $row->idsmartphone; ?>">
                                 <option><?php echo $row->dualsim; ?></option>
                                 <option>Si</option>
                                 <option>No</option>
                              </select>
                          </div>
                           <div class="form-group">
                             <label>¿Tiene lector de Huella?</label>
                             <br>
                                <select name="lectorhuella" class="form-control m-b" value="<?php echo $row->idsmartphone; ?>">
                                 <option><?php echo $row->lectorhuella; ?></option>
                                 <option>Si</option>
                                 <option>No</option>
                              </select>
                          </div> 
                           ...
                           <div class="form-group">
                             ...
                             <br>
                                <select name="microsd" class="form-control m-b" value="<?php echo $row->idsmartphone; ?>">
                                 <option><?php echo $row->microsd; ?></option>
                                 <option>Si</option>
                                 <option>No</option>
                              </select>
                          </div>
                          <div class="form-group">
                            ...
                            <input type="hidden"  class="form-control" name="idsmartphone" value="<?php echo $row->idsmartphone; ?>">
                            <input type="text" name="bateria" class="form-control" value="<?php echo $row->bateria; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <input type="hidden"  class="form-control" name="idsmartphone" value="<?php echo $row->idsmartphone; ?>">
                            <input type="text" name="costo" class="form-control" value="<?php echo $row->costo; ?>">
                          </div> 
                          <div class="form-group">
