         ...
         <section class="main-content">
            ...
            <br>
             ...
             <?php
                ...
                echo form_open_multipart('reportes/listareporteventasproductosfiltrar',$atributos);
             ?>
            ...
            <br>
                        ...
                        <table id="datatable1" class="table table-striped table-hover">
                           <thead>
                              <tr>
                                 ...
                                 <th style="text-align: center;">Cantidad Restante</th>
                           ...
                           <?php
                              $indice=1;
                              foreach ($reportesproductos->result() as $row)
                              {
                           ?>
                              <tr class="gradeX">
                                 <th><?php echo $indice; ?></th>
                                 <td ><?php echo $row->descripcion; ?></td>
                                 <td align="center"><?php echo $row->cantidadrestante; ?></td>
                                 <td align="center" ><?php echo $row->cantidadvendida; ?></td>
                                 <td align="Right"><?php echo $row->ganancianeta; ?> Bs</td>
                                 <td>
                                    ...
                                    <center>
                                       <button type="submit" class="btn btn-primary btn" data-toggle="modal" data-target="#<?php echo $row->idproducto; ?>">Mostrar Detalles</button>
                                    </center>
             ...
             <div class="row">
               <div class="col-lg-12">
                  ...
                  <center>
                     <h3>Total de Gananacias Netas: 
                        <?php 
                        $aa = 0;

                        //print_r($reportes->result()[0]->unidadesvendidas);
                        $row_cnt = $reportesproductos->num_rows();
                        for ($i=0; $i < $row_cnt; $i++)
                        { 
                           $aa = $aa + $reportesproductos->result()[$i]->ganancianeta;
                        }
                        echo $aa ;
                     ...
                     <h3>Total Cantidad Vendida en ese Tiempo: 
                        ...
                        for ($i=0; $i < $row_cnt; $i++)
                        { 
                           $bb = $bb + $reportesproductos->result()[$i]->cantidadvendida;
                        }
                        echo $bb ;
...
<?php 
      ...
      foreach ($reportesproductos->result() as $row)
      {
         ...
         ?>
            <!-- Modal: modalCart -->
               <div class="modal fade" id="<?php echo $row->idproducto; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                 <br>
                 <br>
                     ...
                     <div class="modal-body">
                       ...
                       <table class="table table-hover">
                         <thead>
                           <tr>
                             <th><p>#</p></th>
                             <th><p align="left">Nombre Usuario</p></th>
                             <th><p><center>Descripción</center></p></th>
                             <th><p align="right">Fecha de Venta</p></th>
                             <th><p align="right">Nombre Cliente</p></th>
                             <th><p align="right">Cantidad Vendida</p></th>
                           </tr>
                         </thead>
                         <tbody>
                           ...
                           <?php
                           $listadetallesproductos = $this->reporte_model->mostrardetallesdetallesproductos($row->idproducto,$inicio,$fin);
                           $num = 1;
                           foreach ($listadetallesproductos->result() as $key)
                           {

                              ?>
                                 <tr>
                                   <th scope="row"><?php echo $num; ?></th>
                                   <td align="left"><?php echo $key->nombre; ?></td>
                                   <td><center><?php echo $key->descripcion; ?></center></td>
                                   <td align="right"><?php echo $key->fechaventa; ?></td>
                                   <td align="right"><?php echo $key->razonsocial; ?></td>
                                   <td align="right"><?php echo $key->cantidad; ?></td>
                                 </tr>
                              <?php
                           $num++;
                           }
