      ...
      <section>
         ...
         <section class="main-content">
            <?php 
               ...
               echo form_open_multipart('smartphones/agregar',$atributos);
            ?>
               <center>
                  <button type="submit" class="btn btn-labeled btn-primary pull-right">
                 <span class="btn-label"><i class="fa fa-plus-circle"></i></span>
                  Agregar Nuevo Smartphone</button>
               </center>
            <?php echo form_close(); ?>

                
            <div class="titulo">
              <center><h1>Smartphones</h1></center>
            </div>
                        ...
                        <table id="datatable1" class="table table-striped table-hover">
                           <thead>
                              <tr>
                                 ...
                                 <th>Cámara Frontal (MP)</th>
                                 <th class="sort-numeric">Cámara Trasera (MP)</th>
                                 <th class="sort-alpha">Procesador</th>
                                 <th>Dual SIM</th>
                           ...
                           <?php
                              $indice=1;
                              foreach ($smartphones->result() as $row)
                              {
                           ?>
                              <tr class="gradeX">
                                 <th><?php echo $indice; ?></th>
                                 <td data-title="Nombre Producto"><?php echo $row->nombreproducto; ?></td>
                                 <td data-title="Almacenamiento"><?php echo $row->almacenamiento; ?></td>
                                 <td data-title="Cámara Frontal"><?php echo $row->camarafrontal; ?></td>
                                 <td data-title="Cámara Trasera"><?php echo $row->camaratrasera; ?></td>
                                 <td data-title="Procesador"><?php echo $row->procesador; ?></td>
                                 <td data-title="Dual SIM"><?php echo $row->dualsim; ?></td>
                                 <td data-title="Lector de Huella"><?php echo $row->lectorhuella; ?></td>
                                 <td data-title="Costo"><?php echo $row->costo; ?></td>
                                 <td data-title="Precio"><?php echo $row->precio; ?></td>
                                 <td>
                                    <center>
                                       <?php
                                       $atributos = array('class' => 'form-group','idsmartphone' => 'myform');
                                       echo form_open_multipart('smartphones/modificar',$atributos); 
                                       ?>
                                       <input type="hidden" name="idsmartphone" value="<?php echo $row->idsmartphone ?>">
                                  ...
                                  <td>
                                   <center>
                                       <?php
                                       $atributos = array('class' => 'form-group', 'idsmartphone' => 'myform');
                                       echo form_open_multipart('smartphones/eliminarbd',$atributos); ?>
                                       <input type="hidden" name="idsmartphone" value="<?php echo $row->idsmartphone; ?>">
